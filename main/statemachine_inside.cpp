...
enum States { st_init, ortho, ortho_L, ortho_LL, ortho_R, ortho_RR, diag_LR, diag_RL, diag_RR, diag_LL, st_stop, NB_STATES };
std::vector<string> pathtogoal;
    ...
    switch (cmd) {
      ...
      case 'L':
        switch (current_st) {
          ...
          case ortho_L:
            current_st = ortho_L;
            cerr << "SS90L" << ", " << "FWD1" << ", " << endl;
            break;
          case ortho_R:
            current_st = ortho_L;
            cerr << "SS90R" << ", " << "FWD1" << ", " << endl;
            break;
        }
        break;
